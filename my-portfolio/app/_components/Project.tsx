  ...
  return (
    ...
    >
      <div
        ...
        className="sticky-md static md:sticky flex-3 max-md:m-auto mr-auto space-y-4"
      >
        <Image
          src={image}
          alt={name}
          width={450}
          height={450}
          className="w-full h-auto max-w-lg rounded-sm max-md:w-11/12"
        />
      </div>
      <div className="flex-[2] flex flex-col gap-2">
        ...
        {logo && (
        <Image src={logo} alt={name} width={25} height={25} className="w-6 h-6 rounded-md bg-primary border border-accent" />
        )}
        </div>
        ...
        <div className="flex gap-2 w-full items-end justify-center h-16">
          ...
          {githubLink && (
            <Link href={githubLink} passHref>
              <Button variant="secondary" size="default" className="flex gap-1">
